...
infowindow.setContent("<body bgcolor=yellow><form name=\"f1\" action=\"form.php\" method=\"post\">Tree Name:<input type=text name=tname><br>Tree Type:&nbsp;&nbsp;<input type=text name=ttype><br>Age: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=text name=tage><input type=\"hidden\" name=h1 value="+marker.position.lat().toString()+"> <input type=\"hidden\" name=h2 value="+marker.position.lng().toString()+"> <br><br><input type=submit value=submit></form></body> ");
