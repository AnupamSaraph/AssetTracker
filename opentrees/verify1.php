...
<nav class="art-nav clearfix">
    <ul class="art-hmenu">
		...
		<li><a href="tag.php">Tag Trees</a></li>
		
		<li><a href="search.php">Search Tree</a></li>
		
		<li><a href="verify.php">Verify</a></li>
		<li><a href="downlonload.php">Download</a></li>
...
<div class="art-content-layout">
    <div class="art-content-layout-row">
    <div class="art-layout-cell" style="height:700px">
	
        <p>Track your Trees Online.
        A <font color="green">green maker</font> indicates those trees which have not been cancelled..
        A <font color="blue">blue marker</font> indicates trees which have been cancelled..
        </p>

<?php include('maptry.php') ?>
<!--Open tree map Code. 
...
<br>
<p>Copyright \A9 2011. All Rights Reserved.</p>
<br></div>
