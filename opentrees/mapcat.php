...
<!DOCTYPE html >
  <head>
    ...
    function load() {
      ...
      downloadUrl("genxmlcat.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
          ...
          var html = "<font color=blue><table border=0 cellpadding=0 cellspacing=0><tr><th colspan=2>Tree Information</th></tr><b><font color=red size=2><tr><td>Name</td><td>" + name + "</b> </td><tr><td>Age</td><td>" + age+ "</td></tr><tr><td>Type</td><td>"+type+"</td></tr><tr><td>Area</td><td>"+Area+"</td></tr> <tr><td>City</td><td>"+City+"</td></tr><tr><td>State</td><td>"+State+"</td></tr><tr><td>Country</td><td>"+Country+"</td></tr><tr><td>Height</td><td>"+Height+"</td></tr><tr><td>EmailId</td><td>"+Emailid+"</td></tr></table>";
