...
<nav class="art-nav clearfix">
    <ul class="art-hmenu">
		...
		<li><a href="search.php" class="active">Search Tree</a></li>
...
<pre><font size="5"color="blue"><a href="search.php">Try Different Search Criteria.</a></font></pre>
<!-- serahed category data code start -->        
<?php include('mapcat.php') ?>

<!-- serahed category data code end -->        
